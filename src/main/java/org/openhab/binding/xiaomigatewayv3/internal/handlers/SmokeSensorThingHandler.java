 ...
 */
@NonNullByDefault
public class SmokeSensorThingHandler extends AbstractXiaomiGatewayV3ThingHandler {

    //private final Logger logger = LoggerFactory.getLogger(AbstractXiaomiGatewayV3Handler.class);

    public SmokeSensorThingHandler(Thing thing) {
        super(thing);

        LocalParamCollection.add(new SimpleEntry<String, String>("13.1.85", SMOKE_SENSOR_ALARM));
        LocalParamCollection.add(new SimpleEntry<String, String>("0.1.85", SMOKE_SENSOR_SMOKE_DENSITY));
    }    
