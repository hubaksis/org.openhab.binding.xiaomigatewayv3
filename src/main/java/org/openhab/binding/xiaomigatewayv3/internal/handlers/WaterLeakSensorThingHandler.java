 ...
 */
@NonNullByDefault
public class WaterLeakSensorThingHandler extends AbstractXiaomiGatewayV3ThingHandler {

    //private final Logger logger = LoggerFactory.getLogger(AbstractXiaomiGatewayV3Handler.class);

    public WaterLeakSensorThingHandler(Thing thing) {
        super(thing);

        LocalParamCollection.add(new SimpleEntry<String, String>("3.1.85", WATER_LEAK_SENSOR_ALARM));
    }    
